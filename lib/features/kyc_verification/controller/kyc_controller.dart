import 'package:money_mangmnt/core/widgets/common_dialog_box.dart';
import 'package:money_mangmnt/features/kyc_verification/use_case/kyc_use_case.dart';
...
class KYCController extends AsyncNotifier<void> {
  ...
  Future<void> submitForm(BuildContext context, WidgetRef ref) async {
    ...
    if (!RegExp(r'^\d{10}$').hasMatch(id) ||
      ...
      final errorMessage =
          'National ID or Iqama must be 10 digits and start with 1 or 2.';
    ...
    try {
      ...
      showDialog(
        ...
        builder: (context) => CommonDialog(
          ...
          content:
              'A request has been sent to your Nafath app. Please open it and tap the number shown to securely complete your KYC verification via Saudi digital identity services.',
      ...
      if (Navigator.canPop(context)) {
        Navigator.of(context)
            .pop(); // closes the dialog automatically when process done
      }
