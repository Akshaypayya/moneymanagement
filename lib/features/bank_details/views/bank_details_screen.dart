      ...
      body: SingleChildScrollView(
        ...
        child: ReusableColumn(children: <Widget>[
          CommonTitleAndDescription(
            ...
            description:
                'Add or update your bank account information to securely reload your wallet and withdraw money. Ensure the details are correct to avoid transaction failures or delays.',
          ),
          ReusableSizedBox(
            height: 15,
          ),
