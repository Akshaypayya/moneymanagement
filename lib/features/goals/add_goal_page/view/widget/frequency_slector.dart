...
//     final targetAmount = 10000 + (amountValue * (1000000 - 10000));
//     final targetYear = 2025 + (yearValue * 25).round();
//     final duration = (targetYear - 2025) * 12;

//     final dailyAmount = targetAmount / (duration * 30);
//     final weeklyAmount = targetAmount / (duration * 4);
//     final monthlyAmount = targetAmount / duration;

//     final highlightColor = Colors.teal; //AppColors.current(isDark).primary;
