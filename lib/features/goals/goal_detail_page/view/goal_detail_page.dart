...
//             onPressed: () {
//               Navigator.pushNamed(context, AppRouter.editGoalPage);
//             },
//           ),
//         ),
//         body: SafeArea(
...
//                 data: (goalViewModel) =>
//                     _buildGoalDetailContent(goalViewModel, isDark),
//               ),
//             ),
//           ),
//         ),
...
//   Widget _buildGoalDetailContent(GoalViewModel goalViewModel, bool isDark) {
...
//     // Static transactions data (you can implement transaction API later)
//     // final transactions = [
//     //   {
//     //     'icon': 'assets/bhim.png',
//     //     'title': goalData.goalName,
//     //     'description': 'The amount is auto-debited from your account and added to your Gold savings.',
//     //     'amount': goalData.transactionAmount.toStringAsFixed(2),
//     //     'date': goalData.createdDate,
//     //   },
//     // ];
//     final transactions = [
//       {
...
//           investmentAmount: goalData.formattedWalletBalance,
...
//       return 'Weekly';
//     } else {
//       return '${debitDate}th of every month';
//     }
//   }
// }
